        ...
        json.dumps(
            {
                ...
                "expectation": "При подборе оптимального маршрута от demo-optimal-burt-1 должен выбираться demo-optimal-point-1 как более близкая точка в том же городском контуре.",
            },
            ensure_ascii=False,
            indent=2,
        )
